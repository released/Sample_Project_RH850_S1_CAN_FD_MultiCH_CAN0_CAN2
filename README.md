...
![image](https://github.com/released/Sample_Project_RH850_S1_CAN_FD_MultiCH_CAN0_CAN2/blob/main/bus_err_ch2_2.jpg)
...
![image](https://github.com/released/Sample_Project_RH850_S1_CAN_FD_MultiCH_CAN0_CAN2/blob/main/bus_err_ch0_2.jpg)
...
```c
volatile CAN_BUS_PARAMETER_T can_bus_parameter_ch2 = 
{
...
```c
    unsigned short q_number = can_bus_parameter_ch2.CAN_RX_FIFO_BUFFER_NUM << 5;
```
...
![image](https://github.com/released/Sample_Project_RH850_S1_CAN_FD_MultiCH_CAN0_CAN2/blob/main/EVB_CAN_cfg.jpg)
